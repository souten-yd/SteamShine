...
#include "src/platform/common.h"
  ...
  #include "linux/input/gamescope_eis_input.h"
  #include "linux/input/gamescope_pointer_state.h"
#endif
...
namespace platf::virtualhid {
  ...
  struct client_context_t {
    ...
    /** @brief Release session-scoped pointer buttons before discarding client input. */
    ~client_context_t();
#if defined(__linux__) || defined(__FreeBSD__)
    gamescope_pointer_state_t gamescope_pointer_state;  ///< Combined EIS touch and pen button state.
#endif
